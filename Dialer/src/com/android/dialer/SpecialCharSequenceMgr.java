...
/* lixiaoyan add for Bug 136402 20170119 start */
import android.view.Display;
/* lixiaoyan add for Bug 136402 20170119 end */
...
/* lixiaoyan add for Bug 136402 20170119 end */
//zhanggaiqing add for Bug 137096 20170209 start
import android.os.SystemProperties;
//zhanggaiqing add for Bug 137096 20170209 end
...
public class SpecialCharSequenceMgr {
    ...
    //zhanggaiqing add for Bug 137096 20170209 start
    private static final String YL_VERSION_DISPLAY = "*#96360#*";
    //zhanggaiqing add for Bug 137096 20170209 end
    private static final int IMEI_14_DIGIT = 14;
    //zhuqianqian add for bug 136369 20160210 start
    private static final String SHOW_INFO = "*#96361#*";
    //zhuqianqian add for bug 136369 20160210 end
    /**
    ...
    public static boolean handleChars(Context context, String input, EditText textField) {
        ...
        if (handleDeviceIdDisplay(context, dialString)
                ...
                || handleYLVersion(context, dialString)) {
            return true;
        }
        //zhanggaiqing add for Bug 137096 20170209 end
    ...
    //zhanggaiqing add for Bug 137096 20170209 start
    static private boolean handleYLVersion(Context context, String input){
        if(input.equals(YL_VERSION_DISPLAY)){
            try {
                Intent intent = new Intent(context,YLVersionActivity.class);
                intent.putExtra("product",SystemProperties.get("ro.build.sw_internal_version", "unknown"));
                context.startActivity(intent);
                return true;
            } catch (ActivityNotFoundException e) {
                Log.d(TAG, "no activity to handle showing device info");
    ...
    static boolean handleSecretCode(Context context, String input) {
        ...
        //likuijiang modify for bug 137335 20170218 start
        if (input.equals("*#96463#*")) {
           try {
        ...
        //likuijiang modify for bug 137335 20170218 end
        
        //zhuqianqian add for bug 136369 20160210 start
        if(SHOW_INFO.equals(input)){
           try {
               Intent intent = new Intent();
               intent.setAction(Intent.ACTION_MAIN);
               intent.setClassName("com.spreadst.validationtools", "com.spreadst.validationtools.versioninfo.HardwareInfoActivity");
               intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
               context.startActivity(intent);
            } catch (Exception e) {
                Log.e(TAG, e.toString());
    ...
    static boolean handleDeviceIdDisplay(Context context, String input) {
        TelephonyManager telephonyManager =
                (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
        /* lixiaoyan modify for Bug 136402 20170119 start */
        ...
        if (telephonyManager != null && input.equals(MMI_IMEI_DISPLAY)) {
            ...
            String displayString = "IMEI:\n";
            displayString += telephonyManager.getImei(PhoneConstants.SUB1);
            if (telephonyManager.isMultiSimEnabled()) {
                displayString += "\n" + telephonyManager.getImei(PhoneConstants.SUB2);
            }
            /* liujingxu add for MEID 20170207 start */
            displayString += "\nMEID: \n";
            String deviceMeid = telephonyManager.getMeid(PhoneConstants.SUB1);
            if(TextUtils.isEmpty(deviceMeid) || "0".equals(deviceMeid) || "00000000000000".equals(deviceMeid)){
                  deviceMeid = telephonyManager.getMeid(PhoneConstants.SUB2);
            }
            displayString += deviceMeid;
            /* liujingxu add for MEID 20170207 end */
            int titleId = R.string.imei;
            ...
            alert.getWindow().setLayout((int)(defaultDisplay.getWidth()*0.8), WRAP_CONTENT);
            return true;
        }
        return false;
        /* lixiaoyan modify for Bug 136402 20170119 end */
    }
